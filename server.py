...
from sklearn.metrics import classification_report # For the final test
...
model_architecture = HybridModel(num_classes=2) # Create a NEW 2-class model
...
def weighted_average(metrics: List[Tuple[int, Metrics]]) -> Metrics:
    ...
    # Average accuracy from clients' validation sets
    ...
    # Average loss from clients' validation sets
    ...
    # Log these new global metrics to Azure ML
...
with mlflow.start_run(run_name="FedXViT_Local_Sim_with_Eval") as run:
    ...
    # 2. Load and combine all "Testing" data
